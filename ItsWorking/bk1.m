...
%% Simulation
% figure(2)
mouse_points = zeros(10,250);
y_t = zeros(1,100);
time_counter = 1;
tic;
for t = linspace(0,0.5,250)
%     disp(t)
    spin = spin0; 
    ...
    mouse_points(time_counter,:) = spin';
...
for ii=1:20
    ...
    plot(linspace(0,0.5,250), (abs(mouse_points(:,ii))),'color',[0 0 0])
    hold on
end
    plot(linspace(0,0.5,250), (y_t),'-k','LineWidth',5)